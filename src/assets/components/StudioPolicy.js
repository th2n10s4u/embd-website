    ...
    <React.Fragment>
      ...
      <TemplateTextCard
        ...
        ListText={[
          ...
          "Masks are required for all students. If you are experiencing any COVID related symptoms, please do not enter. Thank you for continuing to keep Evelyn Meinz Ballroom Dance a safe space for our comunity.",
        ]}
        background={false}
        shadow={false}
        centered
